...
from app.domain.journey_finder import JourneyFinder
...
def complex_graph():
    ...
    flights = [
        ...
        FlightEvent(
            ...
            departure_city="MAD",
            arrival_city="LON",
            departure_datetime=datetime(2024, 9, 12, 22, 30),  # Only 30min connection
...
def test_max_flight_events_limit(complex_graph):
    ...
    finder = JourneyFinder(
        flight_graph=complex_graph,
        max_flight_events=0  # Only direct flights
    )
